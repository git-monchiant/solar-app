...
const l = await pool.request().query(`
  UPDATE leads SET
    status = 'pre_survey',
    payment_confirmed = 0, confirmed = 0, survey_confirmed = 0, install_confirmed = 0, review_sent = 0,
    ...
    pre_bill_photo_url = NULL, pre_residence_type = NULL,
    -- survey
    ...
    ca_number = NULL, id_card_number = NULL, id_card_address = NULL,
