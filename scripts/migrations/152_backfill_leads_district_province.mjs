...
//
// ใช้: node scripts/migrations/152_backfill_leads_district_province.mjs --db=solardb_dev
//      node scripts/migrations/152_backfill_leads_district_province.mjs --db=solardb --force
...
if (!dbArg) {
  console.error('Usage: node 152_backfill_leads_district_province.mjs --db=<solardb|solardb_dev> [--force]');
  process.exit(1);
}
