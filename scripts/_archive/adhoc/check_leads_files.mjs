...
const r = await pool.request().query(`
  ...
  WHERE TABLE_NAME = 'leads'
    AND (COLUMN_NAME LIKE '%_url%' OR COLUMN_NAME LIKE '%_files%' OR COLUMN_NAME LIKE '%_signature%' OR COLUMN_NAME LIKE '%permit%' OR COLUMN_NAME LIKE '%docs%' OR COLUMN_NAME LIKE '%document%')
