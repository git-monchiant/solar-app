...
export const ui = {
  ...
  // Labels
  label: "text-[10px] font-semibold tracking-wider uppercase text-gray-400 block mb-1.5",
  labelInline: "text-[10px] font-semibold tracking-[0.1em] uppercase text-gray-400",
  ...
  // Small badges/pills
  badgeBlue: "inline-flex items-center text-[10px] font-semibold uppercase tracking-wider px-1.5 py-0.5 rounded border bg-blue-50 text-blue-700 border-blue-600/15",
  badgePurple: "inline-flex items-center text-[10px] font-semibold uppercase tracking-wider px-1.5 py-0.5 rounded border bg-purple-50 text-purple-700 border-purple-600/15",
  badgeEmerald: "inline-flex items-center gap-1 text-[10px] font-semibold uppercase tracking-wider px-2 py-0.5 rounded border bg-emerald-50 text-emerald-700 border-emerald-600/15",
  badgeAmber: "inline-flex items-center gap-1 text-[10px] font-semibold uppercase tracking-wider px-2 py-0.5 rounded border bg-amber-50 text-amber-700 border-amber-600/15",
  badgeRed: "inline-flex items-center text-[10px] font-semibold uppercase tracking-wider px-1.5 py-0.5 rounded border bg-red-50 text-red-700 border-red-600/15",
  badgeGray: "inline-flex items-center text-[10px] font-semibold uppercase tracking-wider px-1.5 py-0.5 rounded border bg-gray-50 text-gray-600 border-gray-200",
