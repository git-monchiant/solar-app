...
const ADMIN_GROUPS: { title: string; links: AdminLink[] }[] = [
  {
    ...
    links: [
      ...
      },
      {
        href: "/sla",
        label: "SLA",
        roles: ["admin", "sales", "sales_sup", "solar", "solar_sup"],
        icon: <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6l4 2m5-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
      },
      {
        href: "/calendar",
        label: "Calendar",
