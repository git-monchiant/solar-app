...
const typeConfig: Record<string, { icon: string; color: string }> = {
  ...
  survey_ready: { icon: "M9 12.75l2.25 2.25L15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z", color: "bg-emerald-500" },
  survey_ready_cancelled: { icon: "M6 18L18 6M6 6l12 12", color: "bg-amber-500" },
};
...
const TYPE_LABELS: Record<string, string> = {
  ...
  survey_ready: "พร้อมนัด Pre-Survey",
  survey_ready_cancelled: "ยกเลิก Survey Ready",
