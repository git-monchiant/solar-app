...
import { formatThaiDate as formatDate, formatNumber } from "@/lib/utils/formatters";
    ...
    const renderDoneContent = () => (<>
      ...
      <DoneSection color="blue" title="ระบบไฟฟ้า">
        <div className="space-y-0.5 text-sm">
          ...
          <DoneRow label="ค่าไฟ/เดือน" value={lead.survey_monthly_bill != null ? `${formatNumber(lead.survey_monthly_bill)} บาท` : "—"} />
            ...
            {selectedPackages.map(pkg => (
              <div key={pkg.id} className="rounded-lg border border-emerald-200 bg-white p-2">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <div className="text-sm font-bold font-mono tabular-nums">{formatNumber(pkg.price)} ฿</div>
                </div>
                    ...
                    <button key={p.id} type="button" onClick={() => {
                      ...
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <div className="text-right shrink-0">
                          <div className="text-sm font-bold font-mono tabular-nums">{formatNumber(p.price)}</div>
