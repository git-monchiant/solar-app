        ...
        <div className="flex items-start gap-3 mb-3 md:mb-1.5">
          <div className="flex-1 min-w-0 md:w-52 md:flex-none lg:w-72">
            ...
            <div className="text-sm text-gray-500 truncate mt-0.5 font-mono tabular-nums flex items-center gap-1.5">
              <svg className="w-5 h-5 shrink-0 text-emerald-500" fill="currentColor" viewBox="0 0 24 24">
                ...
                <span className="hidden md:inline">
                  ...
                  {(() => {
                    ...
                    const icon = !hasStructured ? null :
                      type === "call" ? (
                        <svg className={iconCls} fill="currentColor" viewBox="0 0 24 24"><path d="M6.62 10.79a15.05 15.05 0 006.59 6.59l2.2-2.2a1 1 0 011.05-.24c1.12.37 2.33.57 3.57.57a1 1 0 011 1V20a1 1 0 01-1 1A17 17 0 013 4a1 1 0 011-1h3.5a1 1 0 011 1c0 1.24.2 2.45.57 3.57a1 1 0 01-.24 1.05l-2.21 2.17z" /></svg>
                      ) : type === "visit" ? (
