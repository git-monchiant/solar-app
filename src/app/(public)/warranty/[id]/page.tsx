...
export default function WarrantyPage() {
  ...
  // ช่องสรุปที่พนักงานกรอกเองนับเป็นหลักฐานว่ามีแบตด้วย — ไม่งั้นงานที่มีแต่ยี่ห้อ/รุ่น
  // ในฟอร์ม (ยังไม่ได้เก็บ serial) จะกรอกแล้วไม่ขึ้นเอกสาร
  const hasBattery = !lead.warranty_no_battery
    && ((d.devices?.batteries.length ?? 0) > 0
      || !!lead.warranty_battery_brand?.trim()
      || !!lead.warranty_battery_model?.trim()
      || lead.warranty_battery_kwh != null
                  ...
                  <Section title="3. โปรแกรมการดูแลระบบ (O&M)">
                    ...
                    <div className="mt-1.5 pl-2">
                      ...
                      <ul className="list-disc pl-5 space-y-0.5">
                        <li>ลูกค้ามีหน้าที่ติดตามกำหนดการเข้ารับบริการ Operation &amp; Maintenance (O&amp;M) และต้องติดต่อบริษัทเพื่อนัดหมายวันและเวลาเข้าดำเนินการภายใน 1 (หนึ่ง) เดือน นับจากวันที่ครบกำหนดการเข้ารับบริการตามระยะเวลาที่กำหนดไว้ในเอกสารฉบับนี้ หากลูกค้าไม่ติดต่อบริษัทภายในระยะเวลาที่กำหนด ให้ถือว่าลูกค้าสละสิทธิ์การรับบริการ O&amp;M ในรอบนั้น ทั้งนี้ ลูกค้ายังคงมีสิทธิ์รับบริการ O&amp;M ในรอบถัดไปตามเงื่อนไขของสัญญา และไม่สามารถนำสิทธิ์ของรอบที่สละสิทธิ์มาทดแทนหรือสะสมกับรอบถัดไปได้</li>
                      </ul>
                    </div>
                  </Section>
