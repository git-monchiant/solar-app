...
type LifecycleRow = { [K in LifecycleCol]: string | null }
  ...
  & { id: number; full_name: string; phone: string | null; house_number: string | null; status: string; pre_doc_no: string | null; payment_confirmed: boolean | null; pre_slip_uploaded: 0 | 1; lost_reason: string | null; order_installments: string | null; order_paid_count: number; created_at: string | null };
